...
mkdir -p src/main/java/org/opencourse/{configs,controllers,models,repositories,services,utils}
mkdir -p src/main/resources
mkdir -p src/test/java/org/opencourse/{configs,controllers,models,repositories,services,utils}
